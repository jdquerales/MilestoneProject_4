...
class TestViews(TestCase):
    ...
    def setUpTestData(cls):
        ...
        Product.objects.create(description='second product',
                               friendly_name='product', price=200, brand='some')
    ...
    def test_sorting_by_price_asc(self):
        response = self.client.get(
            '/products/', {'sort': 'price', 'ordering': 'asc'})
        self.assertEqual(response.status_code, 200)
    ...
    def test_sorting_by_price_desc(self):
        response = self.client.get(
            '/products/', {'sort': 'price', 'ordering': 'desc'})
        self.assertEqual(response.status_code, 200)
        sorting = response.context['current_sorting']
    ...
    def test_sorting_by_category_desc(self):
        response = self.client.get(
            '/products/', {'sort': 'category', 'ordering': 'desc'})
        self.assertEqual(response.status_code, 200)
        sorting = response.context['current_sorting']
    ...
    def test_sorting_by_category_asc(self):
        response = self.client.get(
            '/products/', {'sort': 'category', 'ordering': 'asc'})
        self.assertEqual(response.status_code, 200)
        sorting = response.context['current_sorting']
    ...
    def test_sorting_by_name_asc(self):
        response = self.client.get(
            '/products/', {'sort': 'friendly_name', 'ordering': 'asc'})
        self.assertEqual(response.status_code, 200)
        sorting = response.context['current_sorting']
    ...
    def test_sorting_by_name_desc(self):
        response = self.client.get(
            '/products/', {'sort': 'friendly_name', 'ordering': 'desc'})
        self.assertEqual(response.status_code, 200)
        sorting = response.context['current_sorting']
